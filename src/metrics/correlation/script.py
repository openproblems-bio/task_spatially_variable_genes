...
## VIASH START
par = {
  'input_method': 'resources_test/task_spatially_variable_genes/mouse_brain_coronal/output.h5ad',
  'input_solution': 'resources_test/task_spatially_variable_genes/mouse_brain_coronal/solution.h5ad',
  'output': 'score.h5ad'
}
meta = {
  'name': 'correlation'
