...
meta = [
  ...
  "links" : {
    ...
    "documentation" : "https://bioconductor.org/packages/release/bioc/vignettes/nnSVG/inst/doc/nnSVG.html"
  },
  "runners" : [
    {
      "type" : "executable",
  ...
  "build_info" : {
    "config" : "/home/runner/work/task_spatially_variable_genes/task_spatially_variable_genes/src/methods/nnsvg/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
    "output" : "target/nextflow/methods/nnsvg",
    "viash_version" : "0.9.0",
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/task_spatially_variable_genes/methods/nnsvg",
    "tag" : "build_main"
  },
  "label" : [
    "midtime",
